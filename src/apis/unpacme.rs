...
use crate::controllers::api::APISource::Unpacme;

pub struct UnpacmeAPI;
...
impl APITrait for UnpacmeAPI {
    ...
    {
        client.get(&format!("https://api.unpac.me/api/v1/private/download/{}", hash))
